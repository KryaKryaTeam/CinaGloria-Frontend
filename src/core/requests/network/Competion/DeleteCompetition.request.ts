...
export default class DeleteCompetitionRequest extends NetworkRequest<Data, boolean, void, boolean> {
    ...
    constructor(@inject(TYPES.UserState) userState: UserState, @inject(TYPES.CompetitionState) competitionState: CompetitionState, @inject(TYPES.AdminCompetitionStore) adminStore: AdminCompetitionStore) {
        super(userState);
