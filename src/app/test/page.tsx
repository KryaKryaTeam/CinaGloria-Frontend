...
const mockActions = new Map([
  ["participants", (row: object) => alert(`View participants for: ${JSON.stringify(row)}`)],
]);

const initialCompetitions = [
  { title: "Winter Hackathon 2025",    participants: 142, deadline: "2025-02-28", prize: "$5,000" },
...
export default function TestPage() {
  ...
  const handleLoadMore = () => {
    setCompetitions((prev) => [
      ...prev,
      { title: "New Competition", participants: 0, deadline: "2025-12-31", prize: "$1,000" },
    ]);
  };
