...
import { CompetitionPublicObject, CompetitionStatus } from "@/core/domain/entity/Competion"
...
const MockData: CompetitionPublicObject = {
  ...
  description:
    "A competitive programming event open to all skill levels. Solve algorithmic problems and climb the leaderboard over 30 days. Whether you're a beginner looking to sharpen your skills or a seasoned developer chasing the top spot — everyone is welcome.",
...
> = {
  [CompetitionStatus.DRAFT]:             { label: "Draft",             variant: "secondary",   icon: <FilePen                      className="h-3 w-3" /> },
  [CompetitionStatus.SCHEDULED]:         { label: "Scheduled",         variant: "secondary",   icon: <CalendarClock                className="h-3 w-3" /> },
  [CompetitionStatus.PUBLISHED]:         { label: "Published",         variant: "default",     icon: <CircleDot                    className="h-3 w-3" /> },
  [CompetitionStatus.REGISTRATION]:      { label: "Registration Open", variant: "default",     icon: <UserRoundPlus                className="h-3 w-3" /> },
  [CompetitionStatus.WAITING_FOR_START]: { label: "Starting Soon",     variant: "secondary",   icon: <Hourglass                    className="h-3 w-3" /> },
  [CompetitionStatus.STARTED]:           { label: "In Progress",       variant: "default",     icon: <CircleDot                    className="h-3 w-3" /> },
  [CompetitionStatus.SCORING]:           { label: "Scoring",           variant: "secondary",   icon: <ChartNoAxesColumnIncreasing  className="h-3 w-3" /> },
  [CompetitionStatus.ARCHIVED]:          { label: "Archived",          variant: "outline",     icon: <Archive                      className="h-3 w-3" /> },
  [CompetitionStatus.CANCELED]:          { label: "Canceled",          variant: "destructive", icon: <Ban                          className="h-3 w-3" /> },
}
